...
EE_Config.spawnArea = {x1 = 11335, y1 = 8960, x2 = 11342, y2 = 8957, z = 0}
EE_Config.spawn = EE_Config.worldPointToCellPoint(11339, 8959, 0)
...
EE_Config.safeStart = {x = 11339, y = 8959, z = 0, radius = 20}
