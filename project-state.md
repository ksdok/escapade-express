...
- Pour contourner le non-chargement des squares trop lointains, le spawn joueurs est maintenant fixe sur X=11335..11342, Y=8957..8960, Z=0 et le vehicule d'escape sur X=11345, Y=8957, Z=0
...
- Un nouveau besoin gameplay a ete identifie: nettoyer les zombies dans un rayon de 20 autour du spawn au demarrage pour laisser le temps de choisir les roles; ticket EE-19 cree
- EE-19 est maintenant implemente et valide en jeu: nettoyage ponctuel des zombies autour du spawn via zone safe shared (rayon 20), ce qui laisse le temps de choisir les roles au depart
...
- [x] EE-19 (S/M) - Nettoyer les zombies dans un rayon de 20 autour du spawn au lancement pour securiser le choix initial des roles
...
- 2026-07-19: Ticket EE-19 cree pour nettoyer les zombies dans un rayon de 20 autour du spawn au lancement afin de laisser le temps de choisir les roles
- 2026-07-19: EE-19 implemente en code dans `EscapadeExpressServer.lua` avec config shared `safeStart` (x=11371, y=8945, z=0, rayon=20), retrait one-shot des zombies a l'initialisation, verification `luac -p` OK
- 2026-07-19: Validation en jeu EE-19 OK: la zone safe de depart laisse bien le temps de choisir les roles
- 2026-07-19: Repositionnement actuel du scenario: spawn joueurs sur X=11335..11342, Y=8957..8960, Z=0; point d'ancrage/safeStart sur X=11339, Y=8959, Z=0 (rayon 20); vehicule d'escape sur X=11345, Y=8957, Z=0
